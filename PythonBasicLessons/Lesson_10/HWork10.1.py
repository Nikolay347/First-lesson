...
#####################################################################################
#Draft version #2 (code version with question! Not for passing the task. For error discussing.): As a result, we get a generated list
# within list(or three lists, may be variant). As a result, Test 2 was not passed! Perhaps the code should be complicated
# by methods of opening lists (perhaps decomposition methods)?
#
# def my_pow(x):
#     return x ** 2
#
...
# 2**4 = 16
# 2**8 = 256
# Тобто бачимо виконання результату при незмінності за кожен крок основи і
# змінності ступеня з кроком (*2) за кожен крок. При формуванні функції повинна збільшуватися ступінь числа.
